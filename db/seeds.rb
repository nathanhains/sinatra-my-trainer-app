#create 2 users
nate = User.create(username: "Nate", email: "natehains@yahoo.com", password: "password")
raven = User.create(username: "Raven", email: "ravenmccoy@yahoo.com", password: "password")
